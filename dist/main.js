...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initLocalCoords),\n/* harmony export */   latitudeGlobal: () => (/* binding */ latitudeGlobal),\n/* harmony export */   longitudeGlobal: () => (/* binding */ longitudeGlobal)\n/* harmony export */ });\n/* harmony import */ var _forecast_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./forecast.js */ \"./assets/js/modules/forecast.js\");\n/* harmony import */ var _selectUnitsMeasures_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectUnitsMeasures.js */ \"./assets/js/modules/selectUnitsMeasures.js\");\n\r\n\r\n\r\nlet latitudeGlobal;\r\nlet longitudeGlobal;\r\n\r\nfunction initLocalCoords() {\r\n  return new Promise((resolve, reject) => {\r\n    if (!('geolocation' in navigator)) {\r\n      reject('Geolocalização não é suportada neste navegador.');\r\n    }\r\n    navigator.geolocation.getCurrentPosition(\r\n      (position) => {\r\n        latitudeGlobal = position.coords.latitude;\r\n        longitudeGlobal = position.coords.longitude\r\n        resolve({\r\n          latitude: latitudeGlobal,\r\n          longitude: longitudeGlobal,\r\n        });\r\n        (0,_forecast_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(_selectUnitsMeasures_js__WEBPACK_IMPORTED_MODULE_1__.unitsMetrics);\r\n      },\r\n      (error) => reject('Erro ao obter a localização: ', error.message)\r\n    );\r\n  });\r\n}\r\n\n\n//# sourceURL=webpack://weather-app/./assets/js/modules/localCoords.js?\n}");
